...
nose_image = cv2.imread("/Users/bhawna/PycharmProjects/nosefilter/red-nose.png")
cv2.imshow('',nose_image)
_, frame = cap.read()
...
while True:
    ...
    for face in faces:
        ...
        # Adding the new nose
        nose_clown = cv2.resize(nose_image, (nose_width, nose_height))
        cv2.imshow('',nose_clown.size)
        ...
        cv2.imshow("Nose clown", nose_clown)
